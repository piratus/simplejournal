...
public class XMLRPCClient extends XMLRPCCommon {
	 ...
	 * @param url XMLRPC server address
	 */
	...
	/**
	 * Convenience constructor. Creates new instance based on server String address
	 * @param uri XMLRPC server address
	 * @param username HTTP Server - Basic Authentication - Username
	 * @param password HTTP Server - Basic Authentication - Password
	 */	
...
AuthScope.ANY_REALM),
	 ...
	 * @throws XMLRPCException if response status code is bad
	 */
